...
*/
  ...
  /* --------------------------------------------------
     ...
     -------------------------------------------------- */
  #define pcd8544               1                 // Nokia Display 3310, 5110, 3410
  #define ssd1306               0                 // OLED Display mit SSD1306 Controller
  ...
  #define  fb_size              512               // Framebuffergroesse in Bytes (wenn fb_enable)
