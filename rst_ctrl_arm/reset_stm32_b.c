...
#define invert_boot      0           // bestimmt, ob Aktivieren eines Bootloaders mit lo oder hi Pegel erfolgt
                                     // 0 : Bootloader wird mit Hi-Pegel aktiviert ( STM32 )
                                     // 1 : Bootloader wird mit Lo-Pegel aktiviert ( NXP )
...
// Eingaenge am ATtiny
#define bootsel          PB4         // Leitung zum aktivieren / deaktivieren des Bootloaders, geht an
                                     // den RTS des UART

#define rmabutton        PB3         // fuehrt ueber den Tiny13 einen Reset am Zielcontroller durch
